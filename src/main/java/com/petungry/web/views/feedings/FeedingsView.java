package com.petungry.web.views.feedings;
...
@PageTitle("Feedings")
@Route(value = "feedings", layout = MainLayout.class)
public class FeedingsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public FeedingsView() {
        addClassName("feedings-view");
        setSizeFull();
        grid.setHeight("100%");
